    ...
    return (
        <aside className="absolute left-0 w-[363.84px] bg-white border-r-[0.62px] border-black/30 px-[33.7473px] pt-[81.99px] pb-[61.49px] box-border flex flex-col items-start">
            ...
            <div className="flex flex-row items-center gap-[41px] border border-black/30 px-[20.5px] py-[15.37px] w-[167.62px] h-[46.12px] mb-6">
                ...
                <div className="w-[25.62px] h-[21.78px] flex items-center">
                    <Image
            ...
            <section className="w-[312.6px] flex flex-col gap-6">
                ...
                {/* Show Results Button */}
                <div
                    className="w-full h-[46.12px] bg-black flex items-center justify-center mt-2 cursor-pointer hover:bg-gray-800 transition-colors"
